...
void I86_PIC_SendData(uint8_t data, uint8_t picNum);

// Send operational command to pic
void I86_PIC_SendCommand(uint8_t cmd, uint8_t picNum);

// EnableInterruptss and DisableInterruptss interrupts
void I86_PIC_MaskIRQ(uint8_t irqmask, uint8_t picNum);
